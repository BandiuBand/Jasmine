...
# --- Тригери ---
_SEARCH_KEYWORDS = [
    "пошукай", "пошукати", "пошукаєш", "знайди", "знайти", "загугли", "погугли",
    "глянь в інтернет", "глянь в інтернеті", "перевір в інтернеті",
    "перевір в мережі", "глянь у мережі", "що пишуть", "що нового про",
    "новини про", "новини", "актуальн", "сьогодні", "вчора", "цього тижня",
    "цього місяця", "пошук", "search", "google", "знайди в мережі",
    "доступ до інтернету", "ходити в інет", "ходити в інтернет",
    "в інтернет", "в інтернеті", "погода", "курс долара", "курс євро",
    "що сталося", "останні події", "що відбувається",
]

_FACT_KEYWORDS = [
    "хто такий", "хто така", "що таке", "коли народив", "коли помер",
    "де знаходиться", "столиця", "населення", "біографія", "wikipedia",
    "вікіпедія", "розкажи про", "хто винайшов",
]
