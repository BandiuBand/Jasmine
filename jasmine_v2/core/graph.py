...
def build_jasmine_graph():
    ...
    graph.add_node("day_memory_ingest", day_memory_ingest)
    ...
    graph.add_edge("resolve_memory_space", "day_memory_ingest")
    graph.add_edge("day_memory_ingest", "load_active_memory_context")
